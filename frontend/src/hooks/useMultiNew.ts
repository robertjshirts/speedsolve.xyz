...
// import { RTCState, WSStatus, PeerStatus, CubeType, Result, SessionState, MultiServerMessage, MultiClientMessageType } from '../types';
...
//     results: {},
//     peers: {},
//     rtcState: { rtcStatus: 'disconnected', localStream: null, remoteStream: null },
//   });
//   const [username, setUsername] = useState<string | null>(null);
//   const wsRef = useRef<WebSocket | null>(null);
//   const [rtcState, setRtcState] = useState<RTCState>({ rtcStatus: 'disconnected', localStream: null, remoteStream: null });
...
//   return { state, rtcState, wsStatus, actions };
// }
